...
class ProgressionDeComplementApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.progression_de_complement_endpoint = _Endpoint(
            settings={
                ...
                'operation_id': 'progression_de_complement',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def progression_de_complement(
        self,
        sigle_programme,
        **kwargs
    ):
        """progression_de_complement  # noqa: E501

        Return complement progress  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.progression_de_complement(sigle_programme, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['sigle_programme'] = \
            sigle_programme
        return self.progression_de_complement_endpoint.call_with_http_info(**kwargs)
