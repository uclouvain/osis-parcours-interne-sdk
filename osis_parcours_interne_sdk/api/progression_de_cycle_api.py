...
class ProgressionDeCycleApi(object):
    ...
    def __init__(self, api_client=None):
        ...
        self.progression_de_cycle_endpoint = _Endpoint(
            settings={
                ...
                'operation_id': 'progression_de_cycle',
                'http_method': 'GET',
                'servers': None,
            },
            params_map={
    ...
    def progression_de_cycle(
        self,
        sigle_programme,
        **kwargs
    ):
        """progression_de_cycle  # noqa: E501

        Return cycle progress  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True

        >>> thread = api.progression_de_cycle(sigle_programme, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['sigle_programme'] = \
            sigle_programme
        return self.progression_de_cycle_endpoint.call_with_http_info(**kwargs)
